...
export default function CanvasBackground() {
  ...
  useEffect(() => {
    ...
    // Circular glowing dot texture (Cyan/Blue shades)
    const createDotTexture = () => {
      ...
      if (ctx) {
        ...
        grad.addColorStop(0.35, 'rgba(59, 130, 246, 0.85)');
        grad.addColorStop(0.7, 'rgba(30, 64, 175, 0.35)');
    ...
    const animate = () => {
      ...
      for (let i = 0; i < nodeCount; i++) {
        ...
        for (let j = i + 1; j < nodeCount; j++) {
          ...
          if (dist < maxDist) {
            ...
            // Ice Cyan to Royal Cobalt gradients
      ...
      // Update Data Packets
      const pktArr = packetGeometry.attributes.position.array as Float32Array;
  ...
  return (
    <>
      ...
      />
      <div className="fixed inset-0 pointer-events-none z-[1] bg-grid-pattern opacity-80" />
      <div className="fixed -top-40 left-[10%] w-[500px] h-[500px] rounded-full bg-brand-navy/20 blur-[140px] pointer-events-none z-[1]" />
      <div className="fixed top-[40%] -right-32 w-[450px] h-[450px] rounded-full bg-brand-royal/15 blur-[150px] pointer-events-none z-[1]" />
    </>
  );
}
